...
public class Main {
    public static void main(String[] args) {
        ...
        Colaborator max = colaboratori.stream().max(Comparator.comparingDouble(Colaborator::calculeazaVenitAn)).orElse(null);
        System.out.printf("\nColaborator cu venit net maxim: ");
        if (max != null) max.afisare();
        ...
        for (Colaborator c : colaboratori) {
            ...
            suma.put(t, suma.get(t) + c.calculeazaVenitAn());
